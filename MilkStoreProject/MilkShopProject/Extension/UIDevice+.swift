...
enum Device: String {
    ...
    case ipadPro12_9 = "iPad Pro (12.9-inch) (1st generation)"
    ...
    static var segmentTitle: CGFloat {
        switch current {
        case .ipadPro12_9, .ipadPro12_9_2, .ipadPro12_9_3:
            return 18
        case .ipadPro12_9_4, .ipadPro11, .ipadPro11_2:
            return 15
        default:
            return 13
        }
    ...
    static var current: Device {
        guard let currentDevice = Device.init(rawValue: UIDevice.modelName) else { return Device.unowned }
